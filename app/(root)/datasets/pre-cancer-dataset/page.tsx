...
export default function SignalEcgDatasetPage() {
  return (
    <>
      ...
      <DatasetDescription
        description="Pre-Cancer Dataset based on the Visual Inspection with Acetic Acid (IVA) method."
      ...
      <PreviewLink url="https://drive.google.com/drive/folders/1ZLbie1WrjI4XUs9pZsprZQFkVZhAKxxn?usp=sharing" />
    </>
  );
}
